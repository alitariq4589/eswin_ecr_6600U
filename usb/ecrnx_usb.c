...
#define ECRNX_USB_VID  0x3452  /* TODO: replace with actual Vendor ID */
#define ECRNX_USB_PID  0x6600  /* TODO: replace with actual Product ID */

/* Table of devices that work with this driver */
static const struct usb_device_id ecrnx_usb_ids[] = {
    { USB_DEVICE(ECRNX_USB_VID, ECRNX_USB_PID) },
    { } /* Terminating entry */
};
MODULE_DEVICE_TABLE(usb, ecrnx_usb_ids);

static int ecrnx_usb_probe(struct usb_interface *intf,
                           const struct usb_device_id *id)
{
    pr_info("ECRNX USB: device plugged in (VID=%04x PID=%04x)\n",
            id->idVendor, id->idProduct);
    return 0;  /* TODO: initialize your device here */
}

static void ecrnx_usb_disconnect(struct usb_interface *intf)
{
    pr_info("ECRNX USB: device unplugged\n");
    /* TODO: clean up resources */
}

static struct usb_driver ecrnx_usb_driver = {
    .name       = "ecrnx_usb",
    .probe      = ecrnx_usb_probe,
    .disconnect = ecrnx_usb_disconnect,
    .id_table   = ecrnx_usb_ids,
};
